local settings = {
  ...
  key_playfile = "ENTER",
  key_removefile = "BS",
  key_closeplaylist = "ESC SHIFT+ESC",
...
--END OF SAMPLE REPLACE ]=====]
  ...
  playlist_header = "Playlist manager%N",
  ...
  normal_file = "{\\c&HFFFFFF&}%pos. %name",
  hovered_file = "{\\c&HED9564&}%pos. %name",
  selected_file = "{\\c&HFFFFFF&}%pos. (Selected) %name",
  playing_file = "{\\c&H78C850&}%pos. %name",
  playing_hovered_file = "{\\c&H78C850&}%pos. %name",
  playing_selected_file = "{\\c&H78C850&}%pos. (Selected) %name",
